        ...
        <div className="relative shadow-xl border-2 rounded-xl w-full md:w-1/2 lg:w-1/3 mx-auto mt-3">
            ...
            <form>
                <div className="flex flex-row md:px-0 px-9 md:justify-between px-11">
                    <h1 className="text-left text-xl font-semibold font-sans md:px-0 md:ml-24 p-7 ">Create New Project</h1>
                ...
                <div className="flex flex-col mb-4 px-9 md:px-0">
                    <label className="text-base text-left md:ml-24 font-sans  font-semibold">Project Name *</label>
                    <InputComponent inputType="text" inputValue={projectName} inputOnChange={createProjectName} />
                </div>

                <div className="flex flex-col mb-4 px-9 md:px-0 ">
                    <label className="text-base text-left md:ml-24 font-sans font-semibold ">Description</label>
                    <InputComponent inputType="text" inputOnChange={projectDescription} />
                </div>

                <div className="flex flex-col mb-4 px-9 md:px-0">
                    <label className=" text-base text-left md:ml-24 font-sans font-semibold ">Start Date</label>
                    <InputComponent inputType="date" inputOnChange={projectStartDate} />
                </div>
                <div className="flex flex-col mb-4 px-9 md:px-0">
                    <label className=" text-base text-left md:ml-24 font-sans font-semibold ">Target End Date</label>
                ...
                <div className="flex flex-col mb-4 px-9 md:px-0">
                    <h1 className="text-base text-left md:ml-24 font-sans font-semibold ">Team Members (Optional)</h1>
